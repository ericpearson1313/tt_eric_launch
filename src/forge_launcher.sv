...
//end
initial begin
deltai_rom[0]=16'd144;
deltai_rom[1]=16'd432;
deltai_rom[2]=16'd719;
deltai_rom[3]=16'd1007;
deltai_rom[4]=16'd1295;
deltai_rom[5]=16'd1583;
deltai_rom[6]=16'd1871;
deltai_rom[7]=16'd2158;
deltai_rom[8]=16'd2446;
deltai_rom[9]=16'd2734;
deltai_rom[10]=16'd3022;
deltai_rom[11]=16'd3310;
deltai_rom[12]=16'd3597;
deltai_rom[13]=16'd3885;
deltai_rom[14]=16'd4173;
deltai_rom[15]=16'd4461;
deltai_rom[16]=16'd4748;
deltai_rom[17]=16'd5036;
deltai_rom[18]=16'd5324;
deltai_rom[19]=16'd5612;
deltai_rom[20]=16'd5900;
deltai_rom[21]=16'd6187;
deltai_rom[22]=16'd6475;
deltai_rom[23]=16'd6763;
deltai_rom[24]=16'd7051;
deltai_rom[25]=16'd7339;
deltai_rom[26]=16'd7626;
deltai_rom[27]=16'd7914;
deltai_rom[28]=16'd8202;
deltai_rom[29]=16'd8490;
deltai_rom[30]=16'd8778;
deltai_rom[31]=16'd9065;
deltai_rom[32]=16'd9353;
deltai_rom[33]=16'd9641;
deltai_rom[34]=16'd9929;
deltai_rom[35]=16'd10216;
deltai_rom[36]=16'd10504;
deltai_rom[37]=16'd10792;
deltai_rom[38]=16'd11080;
deltai_rom[39]=16'd11368;
deltai_rom[40]=16'd11655;
deltai_rom[41]=16'd11943;
deltai_rom[42]=16'd12231;
deltai_rom[43]=16'd12519;
deltai_rom[44]=16'd12807;
deltai_rom[45]=16'd13094;
deltai_rom[46]=16'd13382;
deltai_rom[47]=16'd13670;
deltai_rom[48]=16'd13958;
deltai_rom[49]=16'd14245;
deltai_rom[50]=16'd14533;
deltai_rom[51]=16'd14821;
deltai_rom[52]=16'd15109;
deltai_rom[53]=16'd15397;
deltai_rom[54]=16'd15684;
deltai_rom[55]=16'd15972;
deltai_rom[56]=16'd16260;
deltai_rom[57]=16'd16548;
deltai_rom[58]=16'd16836;
deltai_rom[59]=16'd17123;
deltai_rom[60]=16'd17411;
deltai_rom[61]=16'd17699;
deltai_rom[62]=16'd17987;
deltai_rom[63]=16'd18275;
end
